...
import { getActiveGalleryImages, GalleryImage } from '@/lib/supabase/gallery';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6">
      <div className="lg:col-span-1 flex flex-col justify-center">
        ...
        <p className="text-gray-600 text-sm md:text-base">
          The school gallery showcases a variety of memorable moments captured throughout the academic year.
        </p>
        <Link
          href="/gallery"
              ...
              >
                ...
                {hoveredId === image.id && (
                  <div className="absolute inset-0 bg-black/50 flex items-center justify-center transition-opacity">
                    <Link href="/gallery" className="text-white text-2xl md:text-3xl hover:scale-110 transition-transform">
